...
class Tests {
    ...
    @Tag("4")
    fun dateStrToDigit() {
        assertEquals("", dateStrToDigit("aaa aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaZL{>{nxED3p;r3c}[kq!=t)4_ol0X 1WlXgnH>lOm&nZ8]\tMED<^-wf-"))
